...
class UserTesting(APITestCase):
    ...
    def post_user(self, data={}):
        ...
        response = self.client.post(reverse("users-list"), data=user_data)
        return response
    ...
    def test_user_update_password(self):
        ...
        response = self.client.patch(
            reverse("users-detail", kwargs={"pk": user.id}), data={"password": "1235"})
    ...
    def test_login_sucess(self):
        ...
        response = self.client.post(
            reverse('token'), data={"email": "lucas@gmail.com", "password": "123"})
